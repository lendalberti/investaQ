...
class PartsController extends Controller {
	...
	private function formatDialog($data) {
		...
		$pRows  = '';
		$pRows .= "<tr><td>1-24</td>    <td><span id='price_1_24'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->prices->p1_24)))          .  "</span></td><td><input type='text' size='7' id='qty_1_24'>    </td><td><span id='subTotal_1_24'>    </span></td></tr>";	
		$pRows .= "<tr><td>25-99</td>   <td><span id='price_25_99'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->prices->p25_99)))        .  "</span></td><td><input type='text'        size='7' id='qty_25_99'>   </td><td><span id='subTotal_25_99'>   </span></td></tr>";	
		$pRows .= "<tr><td>100-499</td> <td><span id='price_100_499'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->prices->p100_499)))    .  "</span></td><td><input type='text'        size='7' id='qty_100_499'> </td><td><span id='subTotal_100_499'> </span></td></tr>";		
		$pRows .= "<tr><td>500-999</td> <td><span id='price_500_999'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->prices->p500_999)))    .  "</span></td><td><input type='text'        size='7' id='qty_500_999'> </td><td><span id='subTotal_500_999'> </span></td></tr>";	
		$pRows .= "<tr><td>1000+ </td>   <td><span id='price_1000_Plus'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->prices->over_1000)))   .  "</span></td><td><input type='text'        size='7' id='qty_1000_Plus'>   </td><td><span id='subTotal_1000_Plus'>   </span></td></tr>";	
		$pRows .= "<tr><td style='font-weight: bold;'>Distributor</td>   <td><span id='price_Base'>" .  money_format("$%6.2n", trim(floatval($p->parts[0]->distributor_price)))          .  "</span></td><td><input type='text' size='7' id='qty_Base'>     </td><td><span id='subTotal_Base'>     </span></td></tr>";	
		$pRows .= "<tr><td style='font-weight: bold;'>Custom</td>   <td> <input type='text' size='7' id='price_Custom'></td><td><input type='text' size='7' id='qty_Custom'> </td><td><span id='subTotal_Custom'>   </span></td></tr>";	
