...
<form>
	...
	<div class="form"> 
		<div class='quote_section_heading' style='display: none;'>
			<span id='showHide_form_details'>&minus;</span><span style='padding-left: 350px;'>Quote Details</span>
		</div>
		<div id='form_details'>
					...
					<td>
						<table>
							<tr>
								...
								<td>Terms &amp; Conditions</td>    <td><textarea rows="4" cols="40"></textarea></td>
								<td>Manufacturing Lead Times</td>  <td><textarea rows="4" cols="40"></textarea></td>
							</tr>
							<tr>	
								<td>RISL</td>                       <td><textarea rows="4" cols="40"></textarea></td>
								<td>Customer Acknowledgment</td>    <td><textarea rows="4" cols="40"></textarea></td>
							</tr>

							<tr>
								<td>Notes/Comments</td>  <td colspan="3"><textarea rows="4" cols="118"></textarea></td>
							</tr>
