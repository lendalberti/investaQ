...
<?php 
	...
	$this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
			array(
				 	'label' => '<span id="edit_quote_<?php echo $data[\'model\']->id; ?>" >Edit</span> Customer',
...
?>  <!-- $customerContacts[] = array( 'fullname' => $r['fullname'], 'title' => $r['title'], 'email' => $r['email'], 'phone1' => $r['phone1'] ); -->
	...
	<div style='margin-top: 20px;'>
		<ul id='view_contacts'><span>Contact</span> <!--  < ?php echo $edit_contacts_link; ?>  -->
				<?php
					$cc = $data['quoteCustomerContact'];
					echo "<li>" . $cc['first_name'] . ' '  . $cc['last_name'] . ", " . $cc['title'] . ", " . $cc['email'] . ", " . $cc['phone1'] .       "<input type='hidden' name='selectedCustomers[".$cc['id']."]' /></li>";
				?>
		</ul> 
	</div>
